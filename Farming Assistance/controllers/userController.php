	...
	function validPass($password)
	 {
		...
		if (isset($_POST["add_man"])){
		   ...
		   {
			 $err_number="Numeric Value required";
			 $hasError=true;
		    }
		   else
		   {
		...
		if (isset($_POST["edit_user"])){
			...
			if(!$hasError)
		   {
			 ...
			 editCustomer($_POST["id"],$fname,$lname,$uname,$ad,$gender,$email,$pass,$number,$type);
		...
		function editCustomer($id,$fname,$lname,$uname,$ad,$gender,$email,$pass,$number,$type){
			$query="UPDATE users
                SET fname='$fname',
                lname='$lname',
                uname='$uname',
